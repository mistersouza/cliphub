    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-60 backdrop-blur-sm z-50">
      ...
      >
        ...
        <div className="text-xs text-gray-500 text-center p-2">
          <p>
            By continuing, you agree to ClipbHub's{" "}
            <span className="text-gray-800 underline cursor-pointer">
              Terms of Service
            </span>{" "}
            and confirm that you have read ClipbHub's{" "}
            <span className="text-gray-800 underline cursor-pointer">
              Privacy Policy
            </span>
          </p>
        ...
        <div className="border-t border-gray-500 text-sm text-center py-5">
          <p>
            ...
            <span
              ...
              className="text-gray-500 text-base cursor-pointer hover:underline hover:underline-offset-2"
            >
